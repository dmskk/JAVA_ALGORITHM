...
public class C04_baseball_game {
    public static void main(String[] args) {
        ...
        for(int i=0; i<n; i++) {
            for(int j=0; j<3; j++) {
                arr[i][j] = String.valueOf(sc.nextInt());
            }
        }
        ...
        for(int i = 1; i <= 9; i++) {
            for(int j = 1; j <= 9; j++) {
                ...
                for(int k = 1; k <= 9; k++) {
                    ...
                    cnt = 0;
                    for(int t = 0; t < n; t++) {
                        String[] num = arr[t][0].split("");
                        strike = 0;
                        ball = 0;
                        if(Integer.parseInt(num[0]) == i) strike++;
                        if(Integer.parseInt(num[1]) == j) strike++;
                        if(Integer.parseInt(num[2]) == k) strike++;

                        if(Integer.parseInt(num[0]) == j || Integer.parseInt(num[0]) == k) ball++;
                        if(Integer.parseInt(num[1]) == i || Integer.parseInt(num[1]) == k) ball++;
                        if(Integer.parseInt(num[2]) == j || Integer.parseInt(num[2]) == i) ball++;

                        if(strike == Integer.parseInt(arr[t][1]) && ball == Integer.parseInt(arr[t][2])) cnt++;
                    }
