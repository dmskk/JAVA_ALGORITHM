...
/* 문제
두 사람 A와 B는 1부터 10까지의 숫자가 하나씩 적힌 열 장의 카드로 ‘게임’을 한다. 게임은 총 열 번의 ‘라운드’로 구성되고,
각 라운드 마다 자신이 가지고 있는 카드 중 하나를 제시하고, 한 번 제 시한 카드는 버린다. 게임 승패는 다음과 같이 결정된다.
...
https://alms-problem.s3.ap-northeast-2.amazonaws.com/cardgame.png
...
public class C01_cardgame {
    public static void main(String[] args) {
        ...
        if(winA > winB) System.out.println("A");
        else if(winA < winB) System.out.println("B");
